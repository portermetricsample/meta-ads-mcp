...
- [ ] **No field from the account-side reference was used.** This reads public data — nothing in `06-reference/all-fields.md` applies here, because you are connected to nothing.

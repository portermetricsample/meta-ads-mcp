...
- **The budget is under the account minimum** for its currency, which Meta refuses rather than throttles. The exact minimums and the error text are in [errors.md](../../reference/errors.md).
...
- **There is no dayparting or ad-scheduling parameter.** Ads run continuously between their start and end times, so "it is outside its schedule" is not a diagnosis you can make or fix here. The full list is in [what-it-cannot-do.md](../../reference/what-it-cannot-do.md).
...
>
> So you cannot answer "did it exhaust its budget" from these fields. Answer it from daily spend instead: the day-by-day line tells you when delivery stopped, and a campaign that is still spending today has not run out. The full account of why these fields mislead is in [budget pacing](../reporting/budget-pacing.md).
...
- [`facebook_ads_spend`](../../reference/all-fields.md) · [`facebook_ads_impressions`](../../reference/all-fields.md) · [`facebook_ads_reach`](../../reference/all-fields.md)
- [`facebook_ads_date`](../../reference/all-fields.md) · [`facebook_ads_day`](../../reference/all-fields.md) · [`facebook_ads_year_week`](../../reference/all-fields.md)
- [`facebook_ads_status`](../../reference/all-fields.md) · [`facebook_ads_ad_status`](../../reference/all-fields.md) · [`facebook_ads_adset_status`](../../reference/all-fields.md) · [`facebook_ads_campaign_configured_status`](../../reference/all-fields.md)
- [`facebook_ads_campaign_daily_budget`](../../reference/all-fields.md) · [`facebook_ads_campaign_lifetime_budget`](../../reference/all-fields.md) · [`facebook_ads_campaign_budget_remaining`](../../reference/all-fields.md) · [`facebook_ads_adsetdaily_budget`](../../reference/all-fields.md)

...
- [`facebook_ads_age`](../../reference/all-fields.md) · [`facebook_ads_gender`](../../reference/all-fields.md)
- [`facebook_ads_publisher_platform`](../../reference/all-fields.md) · [`facebook_ads_platform_position`](../../reference/all-fields.md)
- [`facebook_ads_device_platform`](../../reference/all-fields.md) · [`facebook_ads_impression_device`](../../reference/all-fields.md)
- [`facebook_ads_country_code`](../../reference/all-fields.md) · [`facebook_ads_country_name`](../../reference/all-fields.md) · [`facebook_ads_region`](../../reference/all-fields.md) · [`facebook_ads_dma`](../../reference/all-fields.md)
- [`facebook_ads_hourly_stats_aggregated_by_advertiser_time_zone`](../../reference/all-fields.md)

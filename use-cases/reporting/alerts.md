...
- **Put the schedule outside the connector.** Your assistant's own scheduled-task feature, if it has one, or an automation tool that can call the server on a cron — see [n8n](../../connect/n8n.md).
...
- [`facebook_ads_offsite_conversion_fb_pixel_lead`](../../reference/all-fields.md) · [`facebook_ads_offsite_conversion_fb_pixel_purchase`](../../reference/all-fields.md)
- [`facebook_ads_cost_per_lead`](../../reference/all-fields.md)

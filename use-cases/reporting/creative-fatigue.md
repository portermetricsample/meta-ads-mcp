...
Ask for **link** click-through rate by name every time. The wide `facebook_ads_ctr` field counts likes, comments and profile taps as clicks, so an ad can lose its actual visits while that number holds steady — see the click fields in [all fields](../../reference/all-fields.md).
...
- [`facebook_ads_frequency`](../../reference/all-fields.md) — impressions per person reached
- [`facebook_ads_reach`](../../reference/all-fields.md) · [`facebook_ads_impressions`](../../reference/all-fields.md)
- [`facebook_ads_cpm`](../../reference/all-fields.md)
- [`facebook_ads_inline_link_click_ctr`](../../reference/all-fields.md) — link clicks only, returned as a decimal fraction

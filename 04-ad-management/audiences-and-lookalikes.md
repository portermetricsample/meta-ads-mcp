...
If someone tells you the customer-file route is unavailable through this connector, they are wrong — [what it cannot do](../06-reference/what-it-cannot-do.md) lists both seed types as supported.
...
- [`facebook_ads_adsettargeting_geo_location_countries`](../06-reference/all-fields.md) · [`facebook_ads_adsettargeting_geo_location_cities`](../06-reference/all-fields.md) · [`facebook_ads_adsettargeting_geo_location_type`](../06-reference/all-fields.md) — `geo_location_type` is where the widened location types show up

...
The day-by-day view also shows you *when* it drifted. A flat line that suddenly halves is a campaign that stopped delivering, not a pacing problem — that belongs in [why delivery stopped](../02-auditing/why-delivery-stopped.md).
...
- `facebook_ads_spend` — see [all fields](../06-reference/all-fields.md)
- `facebook_ads_date`

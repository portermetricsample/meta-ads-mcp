...
- [`facebook_ads_inline_link_click_ctr`](../06-reference/all-fields.md) — a decimal fraction, see the trap above
...
- [`facebook_ads_campaign_name`](../06-reference/all-fields.md) · [`facebook_ads_year_week`](../06-reference/all-fields.md) · [`facebook_ads_month`](../06-reference/all-fields.md)
